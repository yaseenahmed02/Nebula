...
#[allow(dead_code)]
pub const RUSTC: &str = r"/Users/karimelgenidy/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/Users/karimelgenidy/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/karimelgenidy/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.81.0 (eeb90cda1 2024-09-04)";
#[doc=r#"The output of `/Users/karimelgenidy/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/karimelgenidy/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
